...
export interface BackupCompletion extends Completion { createdAt: string }
...
export interface ExportDataRequest { unused?: undefined }
/** Browser-downloadable JSON backup. */
export interface ExportDataResult { filename: string; json: string }
/** JSON selected for validation and atomic incremental import. */
export interface ImportDataRequest { json: string }
/** Counts after a successful incremental import. */
export interface ImportDataResult { importedTopics: number; importedCompletions: number; skippedTopics: number }
...
declare module '@deepseek-ai/dsh-typert-protocol' {
  interface RemoteErrorDetailsMap {
    ...
    'checkin/newer-schema': { readonly retryable?: boolean }
    'checkin/invalid-backup': { readonly retryable?: boolean }
    'checkin/backup-too-large': { readonly retryable?: boolean }
    'checkin/import-conflict': { readonly retryable?: boolean }
  }
}
